...
- [ ] `lab/01_Enunciado_participantes_eu.md` kopia bat talde bakoitzeko
- [ ] `lab/03_Hoja_flags_equipo_eu.md` kopia bat talde bakoitzeko (inprimatuta)
...
- Flagak baliozkotzea talde batek aurkezten duenean (`04_Respuestas_master_eu.md` ikusi)
...
| Taldeak F1-en blokeatuta >15 min | `cansniffer` pista eman edo ID taula eman (oinarrizko mailan soilik) |
